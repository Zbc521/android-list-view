 ...
 */
package com.dongzz.android.zlv;
...
public class ZListView extends ListView implements OnScrollListener {
    ...
    private IZListViewListener mListViewListener;
    ...
    private void initWithContext(Context context) {
        ...
        // init header view
        mHeaderView = new ZListViewHeader(context);
    ...
    public void stopRefresh(boolean isSuccess) {
        if (mPullRefreshing) {
            if (isSuccess) {
                mHeaderView.setState(ZListViewHeader.STATE_SUCCESS);
            } else {
                mHeaderView.setState(ZListViewHeader.STATE_FRESH_FAILT);
            }
...
//                }
    ...
    public void setZListViewListener(IZListViewListener l) {
        mListViewListener = l;
    }
     ...
     */
    public interface IZListViewListener {
